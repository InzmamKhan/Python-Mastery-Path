import pandas as pd
johto_data = pd.read_csv("Source File - Johto_Region.csv")
print("My PokeData for Johto Region:")
print(johto_data)
print()

hoenn_data = pd.read_csv("Source File - Hoenn_Region.csv")
print("My PokeData for Johto Region:")
print(hoenn_data)
print()

kanto_data = pd.read_csv("Source File - Kanto_Region.csv")
print("My PokeData for Johto Region:")
print(kanto_data)
print()
